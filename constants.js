// These constants must all fit into a unique uint8 value
...
export const NUMBER    = 1 << 4;
export const STRING    = 1 << 5;
export const ARRAY     = 1 << 6;
export const OBJECT    = 1 << 7;

// recursive types
export const RECURSION = STRING | ARRAY | OBJECT;
